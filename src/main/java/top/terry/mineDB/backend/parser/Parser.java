package top.terry.mineDB.backend.parser;

import java.util.ArrayList;
import java.util.List;

import top.terry.mineDB.backend.parser.statement.Abort;
import top.terry.mineDB.backend.parser.statement.Begin;
import top.terry.mineDB.backend.parser.statement.Commit;
import top.terry.mineDB.backend.parser.statement.Create;
import top.terry.mineDB.backend.parser.statement.Delete;
import top.terry.mineDB.backend.parser.statement.Drop;
import top.terry.mineDB.backend.parser.statement.Insert;
import top.terry.mineDB.backend.parser.statement.Select;
import top.terry.mineDB.backend.parser.statement.Show;
import top.terry.mineDB.backend.parser.statement.SingleExpression;
import top.terry.mineDB.backend.parser.statement.Update;
import top.terry.mineDB.backend.parser.statement.Where;
